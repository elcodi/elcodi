...
class MenuRepositoryTest extends WebTestCase
{
    ...
    public function testFactoryProvider()
    {
        $this->assertInstanceOf(
            $this->container->getParameter('elcodi.core.menu.repository.menu.class'),
            $this->container->get('elcodi.core.menu.repository.menu')
        );
    }
    ...
    public function testFactoryProviderAlias()
    {
        $this->assertInstanceOf(
            $this->container->getParameter('elcodi.core.menu.repository.menu.class'),
            $this->container->get('elcodi.repository.menu')
        );
    }
}
