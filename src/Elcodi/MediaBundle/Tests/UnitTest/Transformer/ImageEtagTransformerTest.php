...
namespace Elcodi\MediaBundle\Tests\UnitTest\Transformer;

use PHPUnit_Framework_TestCase;

use Elcodi\MediaBundle\Transformer\ImageEtagTransformer;
...
class ImageEtagTransformerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetEtag()
    {
        ...
        $image = $this->getMock('Elcodi\MediaBundle\Entity\Interfaces\ImageInterface');
        $image
            ->expects($this->any())
            ->method("getId")
