 ...
 */
class ReferralLineType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('referrerType', 'choice', array(
                'choices'     => array(
                    ElcodiReferralProgramRuleTypes::TYPE_WITHOUT_COUPON,
                    ElcodiReferralProgramRuleTypes::TYPE_ON_REGISTER,
                    ElcodiReferralProgramRuleTypes::TYPE_ON_FIRST_PURCHASE,
                ),
                'empty_value' => false,
            ))
            ->add('referrerCoupon', 'entity', array('class' => 'ElcodiCouponBundle:Coupon',
            ...
            ->add('invitedCoupon', 'entity', array('class' => 'ElcodiCouponBundle:Coupon',
                'query_builder' => function (EntityRepository $repository) {
                    return $repository
                        ->createQueryBuilder('c')
                        ->where('c.enabled = :enabled')
