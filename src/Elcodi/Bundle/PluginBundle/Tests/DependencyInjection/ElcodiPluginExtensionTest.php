...
namespace Elcodi\Bundle\PluginBundle\Tests\DependencyInjection;
...
class ElcodiPluginExtensionTest extends AbstractExtensionTestCase
{
    /**
    ...
    protected function getContainerExtensions()
    {
        ...
        return [
            new ElcodiPluginExtension($kernelInterface),
        ];
    }
