...
namespace Elcodi\Bundle\StateTransitionMachineBundle\Tests\DependencyInjection;
...
class ElcodiStateTransitionMachineExtensionTest extends AbstractExtensionTestCase
{
    ...
    {
        return [
            new ElcodiStateTransitionMachineExtension(),
        ];
    }
