...
class ConfigurationData extends AbstractFixture
{
    ...
    public function load(ObjectManager $manager)
    {
         ...
         */
        $parameter1 = $this->get('elcodi.factory.configuration')->create();
        $parameter1->setParameter('parameter1')->setValue('value1');
         ...
         */
        $parameter1 = $this->get('elcodi.factory.configuration')->create();
        $parameter1->setParameter('parameter2')->setValue('value2');
        $manager->persist($parameter1);
