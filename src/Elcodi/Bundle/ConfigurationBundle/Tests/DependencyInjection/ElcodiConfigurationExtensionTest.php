...
namespace Elcodi\Bundle\ConfigurationBundle\Tests\DependencyInjection;
...
class ElcodiConfigurationExtensionTest extends AbstractExtensionTestCase
{
    ...
    {
        return [
            new ElcodiConfigurationExtension(),
        ];
    }
