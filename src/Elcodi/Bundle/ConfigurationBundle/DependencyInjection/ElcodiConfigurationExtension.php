...
class ElcodiConfigurationExtension extends AbstractExtension implements EntitiesOverridableExtensionInterface
{
    ...
    protected function getParametrizationValues(array $config)
    {
        return [
            ...
            => $config['mapping']['configuration']['class'],

            "elcodi.core.configuration.entity.configuration.mapping_file"
            => $config['mapping']['configuration']['mapping_file'],

            "elcodi.core.configuration.entity.configuration.manager"
            => $config['mapping']['configuration']['manager'],

            'elcodi.core.configuration.cache_key'
            => $config['configuration']['cache_key'],
        ];
    }
    ...
    public function getConfigFiles(array $config)
    {
        return [
            ...
            'objectManagers',
            [
                'configurationFetcherAdapter/doctrineParameterFetcher',
                $config['configuration']['fetcher'] === DoctrineParameterFetcher::ADAPTER_NAME
            ],
        ];
    }
