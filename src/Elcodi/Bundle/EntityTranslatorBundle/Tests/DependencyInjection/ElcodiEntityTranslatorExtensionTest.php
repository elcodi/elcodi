...
namespace Elcodi\Bundle\EntityTranslatorBundle\Tests\DependencyInjection;
...
class ElcodiEntityTranslatorExtensionTest extends AbstractExtensionTestCase
{
    ...
    {
        return [
            new ElcodiEntityTranslatorExtension(),
        ];
    }
