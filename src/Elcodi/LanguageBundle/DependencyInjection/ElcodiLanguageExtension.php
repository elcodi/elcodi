...
namespace Elcodi\LanguageBundle\DependencyInjection;
...
class ElcodiLanguageExtension extends AbstractExtension implements EntitiesOverridableExtensionInterface
{
    ...
    {
        return [
            'Elcodi\LanguageBundle\Entity\Interfaces\LanguageInterface' => 'elcodi.core.language.entity.language.class',
        ];
    }
}
